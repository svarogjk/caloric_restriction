---
description: 'Designs survival analysis strategies for new research questions. Plans implementation steps including data preprocessing, model selection, validation, and interpretation.'
