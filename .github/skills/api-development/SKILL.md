...
description: Use this skill when creating or modifying FastAPI endpoints, Pydantic models, or API services for this project. Includes patterns for async operations and error handling.
---

# API Development Skill

You are an expert in FastAPI development for the GEO Survival Analysis backend.
