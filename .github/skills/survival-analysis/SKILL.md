...
description: Use this skill when working with survival analysis, Kaplan-Meier curves, Cox regression, hazard ratios, or gene expression survival studies. Helps implement and debug survival analysis code using the lifelines library.
---

# Survival Analysis Skill

You are an expert in survival analysis for gene expression studies using Python's lifelines library.
