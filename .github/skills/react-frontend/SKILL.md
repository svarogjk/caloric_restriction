---
name: react-frontend
description: Use this skill when working on React components, Redux state management, Tailwind styling, or Recharts visualizations in the frontend.
---

# React Frontend Skill

You are an expert in React/TypeScript development for the GEO Survival Analysis frontend.
  ...
  return (
    <ScatterChart width={600} height={400}>
      <XAxis
        dataKey="logHR"
        domain={[-3, 3]}
        label={{ value: 'log₂(Hazard Ratio)', position: 'bottom' }}
      />
      <YAxis
        dataKey="negLogP"
