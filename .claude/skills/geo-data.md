...
Use this skill when working with NCBI GEO (Gene Expression Omnibus) data, downloading datasets, parsing expression matrices, or mapping probe IDs to gene symbols.
