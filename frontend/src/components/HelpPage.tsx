    ...
    const sections: Section[] = [
        {
            ...
            content: (
                <div className="space-y-4">
                    ...
                    <div className="bg-accent-soft border border-border-accent rounded-lg p-4">
                        <p className="text-sm font-medium text-accent-fg mb-1">Free and open access</p>
                    ...
                    <h3 className="font-semibold text-fg-strong mt-4">How it works</h3>
                    <ol className="list-decimal list-inside space-y-2 text-fg text-sm">
                    ...
                    <h3 className="font-semibold text-fg-strong mt-4">Comparison with existing tools</h3>
                    <div className="overflow-x-auto">
                        <table className="text-sm w-full border-collapse">
                            <thead>
                                <tr className="bg-surface-sunken">
                                    <th className="text-left px-3 py-2 border border-border">Tool</th>
                                    <th className="text-left px-3 py-2 border border-border">Data source</th>
                                    <th className="text-center px-3 py-2 border border-border">Cross-cohort meta-analysis</th>
                                    <th className="text-center px-3 py-2 border border-border">Natural language input</th>
                                </tr>
                            </thead>
                            <tbody>
                                {[
                                    ...
                                    <tr key={row.tool} className={row.tool === 'GEO Survival Analysis' ? 'bg-accent-soft font-medium' : ''}>
                                        <td className="px-3 py-2 border border-border">{row.tool}</td>
                                        <td className="px-3 py-2 border border-border">{row.source}</td>
                                        <td className="text-center px-3 py-2 border border-border">{row.meta ? '✓' : '✗'}</td>
                                        <td className="text-center px-3 py-2 border border-border">{row.nl ? '✓' : '✗'}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4 text-sm text-fg">
                    <h3 className="font-semibold text-fg-strong text-base">Running your first analysis</h3>
                    <div className="space-y-3">
                        <div className="flex gap-3">
                            <div className="w-7 h-7 rounded-full bg-accent text-on-accent flex items-center justify-center flex-shrink-0 text-sm font-bold">1</div>
                            <div>
                                <p className="font-medium">Go to the <Link to="/" className="text-accent-fg underline">home page</Link></p>
                                <p className="text-fg-muted">Click one of the example buttons — e.g., <strong>"Lung adenocarcinoma OS"</strong> — to launch a pre-loaded analysis immediately. Results typically appear within 2–5 minutes.</p>
                            </div>
                        </div>
                        <div className="flex gap-3">
                            <div className="w-7 h-7 rounded-full bg-accent text-on-accent flex items-center justify-center flex-shrink-0 text-sm font-bold">2</div>
                            <div>
                                <p className="font-medium">Or type a custom query</p>
                                <p className="text-fg-muted">Use the text box at the bottom. Good queries include a cancer type and a survival endpoint, e.g.:<br />
                                    <code className="bg-surface-sunken px-1 rounded">colorectal cancer overall survival</code><br />
                                    <code className="bg-surface-sunken px-1 rounded">glioblastoma recurrence-free survival</code>
                                </p>
                            </div>
                        </div>
                        <div className="flex gap-3">
                            <div className="w-7 h-7 rounded-full bg-accent text-on-accent flex items-center justify-center flex-shrink-0 text-sm font-bold">3</div>
                            <div>
                                <p className="font-medium">Watch real-time progress</p>
                                <p className="text-fg-muted">A progress bar shows each stage: searching GEO, downloading datasets, mapping probes, running Cox regression.</p>
                            </div>
                        </div>
                        <div className="flex gap-3">
                            <div className="w-7 h-7 rounded-full bg-accent text-on-accent flex items-center justify-center flex-shrink-0 text-sm font-bold">4</div>
                            <div>
                                <p className="font-medium">Explore results</p>
                                <p className="text-fg-muted">The results panel shows a ranked gene table, interactive Kaplan–Meier curves, forest plots, and a volcano plot. Download gene table as CSV or all plots as a ZIP publication package.</p>
                            </div>
                        </div>
                    </div>

                    <h3 className="font-semibold text-fg-strong text-base mt-6">Sample output — lung adenocarcinoma OS</h3>
                    <div className="bg-surface-sunken border border-border rounded-lg p-4 font-mono text-xs overflow-x-auto">
                        <p className="text-fg-muted mb-2"># Top genes (10 datasets analysed, 8 with survival data)</p>
                        <table className="w-full">
                            ...
                            <tbody className="text-fg-strong">
                                {[
                                    ...
                                    <tr key={gene}>
                                        <td className="pr-4 text-accent-fg font-bold">{gene}</td>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4 text-sm text-fg">
                    <h3 className="font-semibold text-fg-strong text-base">Gene ranking table</h3>
                    ...
                    <h3 className="font-semibold text-fg-strong text-base mt-4">Kaplan–Meier curves</h3>
                    ...
                    <h3 className="font-semibold text-fg-strong text-base mt-4">Forest plot</h3>
                    ...
                    <h3 className="font-semibold text-fg-strong text-base mt-4">Volcano plot</h3>
                    ...
                    <h3 className="font-semibold text-fg-strong text-base mt-4">Statistical methods</h3>
                    <ul className="space-y-1">
                        <li><strong>Cox proportional hazards:</strong> <code className="bg-surface-sunken px-1 rounded">lifelines.CoxPHFitter</code> with expression group (high/low, split at median) as covariate.</li>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4 text-sm text-fg">
                    <h3 className="font-semibold text-fg-strong text-base">Analysis settings</h3>
                    ...
                    <h3 className="font-semibold text-fg-strong text-base mt-4">Gene batch mode</h3>
                    ...
                    <h3 className="font-semibold text-fg-strong text-base mt-4">Shareable permalinks</h3>
                    <p>Every saved result has a public URL at <code className="bg-surface-sunken px-1 rounded">/results/&lt;id&gt;</code> that can be shared without requiring the recipient to log in.</p>

                    <h3 className="font-semibold text-fg-strong text-base mt-4">Publication export</h3>
                    ...
                    <h3 className="font-semibold text-fg-strong text-base mt-4">AI chat assistant</h3>
                ...
                <div className="space-y-4 text-sm text-fg">
                    {[
                        ...
                        <div key={q} className="border-b border-border pb-4">
                            <p className="font-medium text-fg-strong">{q}</p>
                            <p className="text-fg-muted mt-1">{a}</p>
                        </div>
                    ))}
                </div>
            ),
    ...
    return (
        <div className="h-full overflow-y-auto bg-surface-sunken">
            <div className="max-w-5xl mx-auto px-4 py-8">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-fg-strong">Help & Documentation</h1>
                ...
                <div className="flex gap-6">
                    ...
                    {/* Content */}
                    <div className="flex-1 bg-surface rounded-xl shadow-sm border border-border p-6">
