...
const ClinicalReport: React.FC<ClinicalReportProps> = ({ results }) => {
    ...
    return (
        <div className="print-report">
            ...
            >
                RESEARCH USE ONLY — NOT FOR CLINICAL DECISION-MAKING. This report describes prognostic
                (outcome-associated) gene expression evidence aggregated from public GEO cohorts. It does
                NOT predict response to any therapy and must not be used to direct patient treatment.
            </div>
            ...
            <table style={{ width: '100%', fontSize: '10pt', marginBottom: 12 }}>
                <tbody>
                    ...
                    <tr>
                        <td style={{ fontWeight: 600 }}>Prognostic genes identified</td>
            ...
            <p style={{ fontSize: '9.5pt', margin: '2px 0' }}>
                ...
                prognosis). HR &lt; 1: higher expression is associated with longer survival (better
                prognosis). Genes significant across more independent cohorts carry stronger evidence.
            </p>
            ...
            >
                Generated by GEO Survival Analysis. Prognostic, research-use-only evidence. Methods and
                per-cohort statistics are available in the publication export package.
