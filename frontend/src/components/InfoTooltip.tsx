    ...
    return (
        <span className="relative inline-flex items-center">
            <button
                ...
                className="text-fg-faint hover:text-accent-fg text-xs cursor-help"
            >
                ⓘ
            </button>
            {open && (
                <span
                    role="tooltip"
                    className="absolute z-50 left-1/2 -translate-x-1/2 bottom-full mb-1 w-56 bg-inverse text-on-inverse text-xs rounded px-2 py-1.5 shadow-lg"
                >
                    {text}
                </span>
            )}
